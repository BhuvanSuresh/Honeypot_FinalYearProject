...
# # Function to read CSV file and update image_paths array
# def update_image_paths_from_csv(csv_file):
#     try:
#         print("Read data now")
...
#     while True:
#         time.sleep(10)  # Sleep for 10 seconds before updating again
        
#         image_paths = update_image_paths_from_csv(csv_file)
#         if image_paths:
